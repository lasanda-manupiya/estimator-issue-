    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-12">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Import Library</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
        <h3 class="card-title">Import Library</h3><hr>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('library.projects.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
