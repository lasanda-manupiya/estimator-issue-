<tr class="main-activity-row-{{ $mainActivity->id }} expandable" data-row-id="{{ $mainActivity->id }}">
    ...
    <td>
        <input type="text" name="main_activity[{{ $mainActivity->id }}][area]" value="{{ $mainActivity->area }}" id="area_main{{ $mainActivity->id }}" class="form-control area_main" onchange="update_main_activity_row('{{ route('library.ajax.update.project.main.activity.row', $mainActivity->id) }}', 'area', this.value, '{{ $mainActivity->id }}');">
    </td>
    <td>
        <input type="text" name="main_activity[{{ $mainActivity->id }}][level]" value="{{ $mainActivity->level }}" id="level_main{{ $mainActivity->id }}" class="form-control level_main" onchange="update_main_activity_row('{{ route('library.ajax.update.project.main.activity.row', $mainActivity->id) }}', 'level', this.value, '{{ $mainActivity->id }}');">
    </td>
    <td>
        <input type="text" name="main_activity[{{ $mainActivity->id }}][activity]" value="{{ $mainActivity->activity }}" id="activity_main{{ $mainActivity->id }}" class="form-control activity_main" onchange="update_main_activity_row('{{ route('library.ajax.update.project.main.activity.row', $mainActivity->id) }}', 'activity', this.value, '{{ $mainActivity->id }}');">
    </td>
    <td>
    ...
    <td>
        <input type="text" name="main_activity[{{ $mainActivity->id }}][unit]" value="{{ $mainActivity->unit }}" id="unit_main{{ $mainActivity->id }}" class="form-control unit_main" onchange="update_main_activity_row('{{ route('library.ajax.update.project.main.activity.row', $mainActivity->id) }}', 'unit', this.value, '{{ $mainActivity->id }}');">
