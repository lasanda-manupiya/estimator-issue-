<tr class="sub-activity-row-{{ $subActivity->id }} expandable" data-row-id="{{ $subActivity->id }}">
    ...
    <td>
        <input type="text" name="sub_activity[{{ $subActivity->id }}][rate]" value="{{ $subActivity->rate }}" id="rate_sub{{ $subActivity->id }}" class="form-control rate_sub"  onchange="update_sub_activity_row('{{ route('estimates.ajax.update.project.sub.activity.row', $subActivity->id) }}', 'rate', this.value, '{{ $subActivity->id }}', '{{ $subActivity->mainActivity->id }}');">
    </td>
     <td>
    ...
    <td>
     <input type="text" name="sub_activity[{{ $subActivity->id }}][totalco]" value="{{ round($subActivity->totalco,2) }}" id="totalco_sub{{ $subActivity->id }}" class="form-control totalco_sub" onkeypress="javascript:return isNumber(event)" disabled="disabled" onchange="update_sub_activity_row('{{ route('estimates.ajax.update.project.sub.activity.row', $subActivity->id) }}', 'totalco', this.value, '{{ $subActivity->id }}', '{{ $subActivity->mainActivity->id }}');">
                                                                </td>
    <td>
