...
<section class="content">
    <div class="card">
        <div class="card-body">
            <div class="row">
				...
				<!--<div class="col-md-3">
				 <div class="form-group">
                        {{ Form::select('mainactivity', $allProjects_one,  [
                            'class' => "form-control multiselect-dropdown",
                            'id' => "mainactivity",
                            'data-live-search'=>'true',
                            'onchange'=> 'changeMain(this.value)'
                        ]) }}
                    </div>
                    </div>-->
                <div class="col-md-12">
                        ...
                        @else
                            ...
                            <button type="button" onclick="return alert('Select any project first to copy the project')" class="mb-2 mr-2 btn btn-dark btn-sm">Copy Project</button>&nbsp;
                            <button type="button" onclick="return alert('Select any project first to save the project')" class="mb-2 mr-2 btn btn-dark btn-sm">Save Project</button>&nbsp;
    ...
    @isset($project)
        <div class="printable_estimate_div" id="printable_estimate_div">
            <div class="card project-estimate-detail" style="display:none">
                {{ Form::open(['route' => 'estimates.projects.update.detail']) }}
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Project Estimate Detail</h3><hr>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Project Estimate</h3><hr>
                    ...
                    <div class=" border col-md-3 float-left p-3 ml-2 mt-0" style="display:none">
                        ...
                        <input type="button" class="btn btn-primary btn-sm aa" value="Copy to Library"  id="copy_multiple_to_library" style="background-color:#0033FF; color:#FFFFFF; cursor:pointer; font-size:16px; border: none;">                       
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="button" class="mb-2 mr-2 btn btn-dark btn-sm" value="Collaps all" title="Collapse all" id="collaps_all">
                ...
                <div class="card-body table-responsive">
                   ...
                   <div class="col-md-6">
						   ...
						   <input id="myInput" type="text" onKeyUp="myFunction()">&nbsp&nbsp&nbsp<a href="{{ route('estimates.projects') }}" class="mb-2 mr-2 btn btn-info btn-sm">
                                Back&nbsp
                            </a>
						   
						  </div>
                            </div>  
                    <table class="table table-bordered main-activity-table" id="main_activity_table" style="width:100%">
                        <thead class="table-success" style="background-color: #84c1ff;position:sticky!important;top:0px!important;" >
                            <tr>
                                ...
                                <th width="2%">Rate</th>
                                <th width="3%">Total</th>
                                <th width="2%">Unit Qty</th>
                                <th width="2%">Unit Rate</th>
                                <th width="2%">Unit</th>
                                <th width="1%">
                                    @if (auth()->user()->can('access', 'estimates add'))
                                        <a title="Add main activity" href="javascript:;" class="btn btn-sm btn-success add-main-activity-row" data-project-id="{{ $project->id }}" data-route="{{ route('estimates.ajax.add.main.activity.row', $project->id) }}">
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    @endif
                                </th>
...
<script type="text/javascript">
    ...
    function changeProject(projectId) {
        window.location = "{{ route('estimates.projects') }}/" + projectId+"/";
    }
	function changeMain(mainactivity) {
        window.location = "{{ route('estimates.projects') }}/" + mainactivity+"/";
    }
    $(function(){
