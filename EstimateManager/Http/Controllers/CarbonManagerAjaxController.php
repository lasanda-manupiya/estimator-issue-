...
class CarbonManagerAjaxController extends Controller
{
/**
    ...
    public function addMainActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project3.add_main_activity_row', compact('mainActivity'))->render();
        }
    ...
    public function addSubActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project3.add_sub_activity_row', compact('subActivity'))->render();
        }
    ...
    public function addActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project3.add_activity_row', compact('activity'))->render();
        }
    ...
    public function showProjectEstimateDetail(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view =  view('estimatemanager::project3.project_estimate_detail', compact(
                'project',
                'project_total',
                'project_hr_total',
                'project_mhr_total',
    ...
    public function showProjectFormulaDetail(Request $request, $id){
        ...
        if($request->ajax()){
            $project = Project::findOrFail($id);
            $view = view('estimatemanager::project3.project_formulas_detail', compact('project'))->render();
        }
