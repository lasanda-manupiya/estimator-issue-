...
class EstimateManagerAjaxController extends Controller
{
    ...
    public function addMainActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project.add_main_activity_row', compact('mainActivity'))->render();
        }
    ...
    public function addSubActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project.add_sub_activity_row', compact('subActivity'))->render();
        }
    ...
    public function addActivityRow(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            $view = view('estimatemanager::project.add_activity_row', compact('activity'))->render();
        }
    ...
    public function updateProjectMainActivityRow(Request $request, $id){
        if($request->ajax()){
            try {
                ...
                if($request->column == "co" || $request->column == "totalco"||$request->column == "quantity" || $request->column == "rate" || $request->column == "total" || $request->column == "unit" || $request->column == "unit_qty")
	            {
                    $mainActivity->quantity = $request->quantity;
                    $mainActivity->rate = $request->rate;
                    $mainActivity->total = $request->total;
                    $mainActivity->co = $request->co;
                    $mainActivity->totalco = $request->totalco;
        ...
        if($request->ajax()){
            try {
                ...
                if($request->column == "co" || $request->column == "totalco"||$request->column == "quantity" || $request->column == "rate" || $request->column == "total" || $request->column == "unit" || $request->column == "unit_qty")
	            {
                    ...
                    $subActivity->co = $request->co_sub;
                    $subActivity->totalco = $request->totalco_sub;
                    ...
                    $mainActivity->totalco = $request->totalco_main;
                    $mainActivity->co = $request->co_main;
		...
		if($request->column == "co" || $request->column == "totalco"||$request->column == "quantity" || $request->column == "rate" || $request->column == "total" || $request->column == "unit" || $request->column == "unit_qty")
	            {
                    ...
                    $activity->totalco = $request->totalco;
                    $activity->co = $request->co;
    ...
    public function showProjectEstimateDetail(Request $request, $id){
        ...
        if($request->ajax()){
            ...
            if($project->mainActivities->isNotEmpty()){
                ...
                $totalco_main = $totalco_main + $mainActivity->totalco;
    ...
    public function updateProjectFormulaRow(Request $request, $id){
        if($request->ajax()){
            ...
            $t=str_replace("rate",1,$request->value);
            $t=str_replace("hr",1,$request->value);
        ...
        {          
            try {                
                ...
                \DB::commit();
                return response()->json(['status'=> true, 'message'=> 'The formula has been Updated successfully!']);
            } catch (\Exception $e) {
                \DB::rollBack();
            }
